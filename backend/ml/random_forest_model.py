...
Canonical Random Forest forecasting model.
...
def print_evaluation(evaluation: Evaluation) -> None:
    print(f"\n=== {evaluation.horizon}-TRADING-DAY RANDOM FOREST ===")
...
def print_current_forecasts(
    ...
    print("\n=== CURRENT RANDOM FOREST FORECASTS ===")
...
def main() -> None:
    ...
    print("CANONICAL RANDOM FOREST MODEL")
    print("=" * 70)
    ...
    print("\n=== RANDOM FOREST EVALUATION: PASSED ===")
    print(
